...
#nullable restore
#line 60 "D:\Proyectos\Net\MercedesBenzWeb\MercedesBenzServerWeb\Pages\ReportePages\ReporteSemaforos.razor"
    ...
    private async Task OnDownload()
    {
        ...
        (string mensajeResponse, byte[] respuestaResponse) = await Service.DescargarReportePostAsync("reportes/semaforosDescargar", model);
    ...
    private async Task ConsultarDatos(int Pagina = 1)
    {
        ...
        (string mensajeResponse, RespuestaPaginada respuestaResponse) = await Service.ConsultarReportePostAsync("reportes/semaforos", model, paginacion);
