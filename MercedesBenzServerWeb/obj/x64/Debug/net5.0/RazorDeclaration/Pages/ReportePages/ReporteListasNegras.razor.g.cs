...
#line 62 "D:\Proyectos\Net\MercedesBenzWeb\MercedesBenzServerWeb\Pages\ReportePages\ReporteListasNegras.razor"
    ...
    private async Task OnDownload()
    {
        ...
        (string mensajeResponse, byte[] respuestaResponse) = await Service.DescargarReportePostAsync("reportes/listaNegraDescargar", model);
    ...
    private async Task ConsultarDatos(int Pagina = 1)
    {
        ...
        (string mensajeResponse, RespuestaPaginada respuestaResponse) = await Service.ConsultarReportePostAsync("reportes/listaNegra", model, paginacion);
