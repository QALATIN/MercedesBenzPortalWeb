...
#nullable restore
#line 61 "D:\Proyectos\Net\MercedesBenzWeb\MercedesBenzServerWeb\Pages\ReportePages\ReporteEnvioDetalles.razor"
    ...
    private async Task OnDownload()
    {
        ...
        (string mensajeResponse, byte[] respuestaResponse) = await Service.DescargarReportePostAsync("reportes/detalleEnvioDescargar", model);
    ...
    private async Task ConsultarDatos(int Pagina = 1)
    {
        ...
        (string mensajeResponse, RespuestaPaginada respuestaResponse) = await Service.ConsultarReportePostAsync("reportes/detalleEnvio", model, paginacion);
