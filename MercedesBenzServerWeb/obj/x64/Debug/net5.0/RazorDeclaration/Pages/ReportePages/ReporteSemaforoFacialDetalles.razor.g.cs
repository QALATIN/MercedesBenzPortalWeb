...
#line 56 "D:\Proyectos\Net\MercedesBenzWeb\MercedesBenzServerWeb\Pages\ReportePages\ReporteSemaforoFacialDetalles.razor"
    ...
    private async Task OnDownload()
    {
        ...
        (string mensajeResponse, byte[] respuestaResponse) = await Service.DescargarReportePostAsync("reportes/SemaforoFacialDetalleDescargar", model);
    ...
    private async Task ConsultarDatos(int Pagina = 1)
    {
        ...
        (string mensajeResponse, RespuestaPaginada respuestaResponse) = await Service.ConsultarReportePostAsync("reportes/SemaforoFacialDetalle", model, paginacion);
