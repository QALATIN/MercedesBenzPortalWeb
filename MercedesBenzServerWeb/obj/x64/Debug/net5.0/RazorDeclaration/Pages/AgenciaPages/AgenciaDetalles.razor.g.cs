...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/agenciaDetalles/{id}")]
    public partial class AgenciaDetalles : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 49 "D:\Proyectos\Net\MercedesBenzWeb\MercedesBenzServerWeb\Pages\AgenciaPages\AgenciaDetalles.razor"
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
            (string mensajeResponse, Agencia agenciaResponse) = await Service.GetByIdAsync(int.Parse(Id));
        }
        catch (Exception ex)
        {
    ...
    private void Return()
    {
        NavigationManager.NavigateTo("/agencialist");
    }
    ...
    private async void Delete(int id, string nombre)
    {
        if (await JS.Confirmar("Confirmar", "¿Está seguro de eliminar la Agencia: " + nombre + "?", IJSExtensions.TipoMensajeSweetAlert.question, "Confirmar Eliminación!"))
        {
            ...
            {
                mensajeError = "Error desconocido, no fue posible eliminar la agencia " + nombre + " " + ex.Message;
