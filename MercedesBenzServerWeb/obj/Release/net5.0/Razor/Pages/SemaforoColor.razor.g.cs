#pragma checksum "D:\Proyectos\Net\MercedesBenzWeb\MercedesBenzServerWeb\Pages\SemaforoColor.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a6edd89b58e2fc302ed556db6927ec7421ffa5b4"
// <auto-generated/>
...
#line hidden
#nullable disable
    public partial class SemaforoColor : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 1 "D:\Proyectos\Net\MercedesBenzWeb\MercedesBenzServerWeb\Pages\SemaforoColor.razor"
              nombreClase
...
#nullable restore
#line 3 "D:\Proyectos\Net\MercedesBenzWeb\MercedesBenzServerWeb\Pages\SemaforoColor.razor"
       
    [Parameter] public string NombreSemaforo { get; set; } = "Gris";
    [Parameter] public string Estilo { get; set; } = "";
    private string nombreClase = "mbz-span-sem-";

    protected override void OnParametersSet()
    {
        if(!string.IsNullOrEmpty(NombreSemaforo))
        {
            nombreClase = "mbz-span-sem-";
            switch (NombreSemaforo.ToUpper())
            {
                case "VERDE":
                    nombreClase += "verde";
                    break;
                case "AMARILLO":
                    nombreClase += "amarillo";
                    break;
                case "ROJO":
                    nombreClase += "rojo";
                    break;
