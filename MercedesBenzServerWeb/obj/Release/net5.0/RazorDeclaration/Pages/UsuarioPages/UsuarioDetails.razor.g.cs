...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/usuariodetails/{id}")]
    public partial class UsuarioDetails : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 49 "D:\Proyectos\Net\MercedesBenzWeb\MercedesBenzServerWeb\Pages\UsuarioPages\UsuarioDetails.razor"
       
    [Parameter]
    public string Id { get; set; }

    public UsuarioEdicion usuario { get; set; } = null;
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
            usuario = await Service.GetByIdAsync(int.Parse(Id));
        }
        catch (Exception ex)
        {
    ...
    private async void Delete(int id, string nombre)
    {
        if (await JS.Confirmar("Confirmar", "¿Está seguro de eliminar al Usuario: " + nombre + "?", IJSExtensions.TipoMensajeSweetAlert.question, "Confirmar Eliminación!"))
        {
            ...
            {
                mensajeError = "Error desconocido, no fue posible eliminar al usuario " + nombre + " " + ex.Message;
